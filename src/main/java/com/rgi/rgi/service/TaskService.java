...
public interface TaskService {
    ...
    TaskDetail getTask(String userSession, String taskCode) throws UserNotFoundException;
    ...
    Task save(String userSession, TaskForm newTask) throws UserNotFoundException;
